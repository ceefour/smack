 ...
 */
public class DefaultEntityCapsManager implements EntityCapsManager {

    private static final Map<String, MessageDigest> SUPPORTED_HASHES = new HashMap<String, MessageDigest>();

    protected static EntityCapsPersistentCache persistentCache;

    private static Map<Connection, DefaultEntityCapsManager> instances = Collections
            .synchronizedMap(new WeakHashMap<Connection, DefaultEntityCapsManager>());
        ...
        Connection.addConnectionCreationListener(new ConnectionCreationListener() {
			...
			public void connectionCreated(Connection connection) {
                if (connection instanceof XMPPConnection)
                    new DefaultEntityCapsManager(connection);
            }
        });
    ...
    private DefaultEntityCapsManager(Connection connection) {
    ...
    private void init() {
        ...
        connection.addPacketListener(new PacketListener() {
            ...
            public void processPacket(Packet packet) {
                ...
                CapsExtension ext = (CapsExtension) packet.getExtension(DefaultEntityCapsManager.ELEMENT,
                        DefaultEntityCapsManager.NAMESPACE);
    ...
    public static synchronized EntityCapsManager getInstanceFor(Connection connection) {
        ...
        if (entityCapsManager == null) {
            entityCapsManager = new DefaultEntityCapsManager(connection);
        }
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#enableEntityCaps()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#disableEntityCaps()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#entityCapsEnabled()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#removeUserCapsNode(java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#getCapsVersion()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#getLocalNodeVer()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#areEntityCapsSupported(java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#areEntityCapsSupportedByServer()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.jivesoftware.smackx.entitycaps.EntityCapsManager#updateLocalEntityCaps()
	 */
    @Override
