...
import org.jivesoftware.smackx.entitycaps.LLEntityCapsManager;
import org.jivesoftware.smackx.packet.DataForm;
import org.jivesoftware.smackx.packet.DiscoverInfo;
import org.jivesoftware.smackx.packet.DiscoverItems;

/** 
 * LLServiceDiscoveryManager acts as a wrapper around {@link ServiceDiscoveryManager}
 * as {@link ServiceDiscoveryManager} only creates an interface for requesting service
 * information on existing {@link Connection}s. Simply said it creates new connections
...
public class LLServiceDiscoveryManager {
    ...
    private final LLEntityCapsManager capsManager;
    ...
    private LLServiceDiscoveryManager(LLService llservice) {
        ...
        // Entity Capabilities
        capsManager = new LLEntityCapsManager();
		...
		public void capsVerUpdated(String ver) {
            synchronized (service) {
                try {
                    ...
                    presence.setHash(LLEntityCapsManager.HASH_METHOD);
